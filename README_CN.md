...
| 项目 | 简介 | 网站 |
|---------|-------------|---------|
| [HSAW](https://hsaw.dev) | 人类主权与福祉 — 0 公理白皮书（基础）| hsaw.dev |
| [AIZP](https://aizp.dev) | AI 逻辑重心引力协议 — 运行时行为对齐（本项目）| aizp.dev |
...
| [SoulBot](https://soulbot.dev) | AI Agent 运行时与框架 | soulbot.dev |
| [SoulACP](https://soulacp.dev) | 适配器库 — 桥接 CLI 工具与 LLM 提供方 | soulacp.dev |
